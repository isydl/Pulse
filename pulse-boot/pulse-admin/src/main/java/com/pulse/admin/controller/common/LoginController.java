package com.pulse.admin.controller.common;
...
import com.pulse.admin.customize.service.login.dto.CaptchaDTO;
...
import com.pulse.infrastructure.annotations.ratelimit.RateLimitKey;
import com.pulse.admin.customize.service.login.LoginService;
...
public class LoginController {
    ...
    public String index() {
        return StrUtil.format("欢迎使用{}后台管理框架，当前版本：v{}，请通过前端地址访问。",
            pulseConfig.getName(), pulseConfig.getVersion());
    }
