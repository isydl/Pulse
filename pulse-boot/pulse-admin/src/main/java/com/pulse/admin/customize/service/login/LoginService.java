...
import com.pulse.common.constant.Constants.Captcha;
...
import com.pulse.infrastructure.thread.ThreadPoolManager;
...
public class LoginService {
    ...
    public CaptchaDTO generateCaptchaImg() {
        ...
        if (isCaptchaOn) {
            ...
            // 生成验证码
            String captchaType = PulseConfig.getCaptchaType();
    ...
    public String decryptPassword(String originalPassword) {
        byte[] decryptBytes = SecureUtil.rsa(PulseConfig.getRsaPrivateKey(), null)
