package com.pulse.infrastructure.annotations.ratelimit;

import com.pulse.infrastructure.annotations.ratelimit.implementation.MapRateLimitChecker;
import com.pulse.infrastructure.annotations.ratelimit.implementation.RedisRateLimitChecker;
...
@Component
@Slf4j
@ConditionalOnExpression("'${pulse.embedded.redis}' != 'true'")
