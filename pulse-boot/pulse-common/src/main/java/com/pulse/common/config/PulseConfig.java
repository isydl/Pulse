...
public class PulseConfig {
    ...
    public void setFileBaseDir(String fileBaseDir) {
        PulseConfig.fileBaseDir = fileBaseDir  + File.separator + Constants.RESOURCE_PREFIX;
    }
    ...
    public void setApiPrefix(String apiDocsPathPrefix) {
        PulseConfig.apiPrefix = apiDocsPathPrefix;
    }
    ...
    public void setAddressEnabled(boolean addressEnabled) {
        PulseConfig.addressEnabled = addressEnabled;
    }
    ...
    public void setCaptchaType(String captchaType) {
        PulseConfig.captchaType = captchaType;
    }
    ...
    public void setRsaPrivateKey(String rsaPrivateKey) {
        PulseConfig.rsaPrivateKey = rsaPrivateKey;
    }
    ...
    public void setDemoEnabled(boolean demoEnabled) {
        PulseConfig.demoEnabled = demoEnabled;
    }
