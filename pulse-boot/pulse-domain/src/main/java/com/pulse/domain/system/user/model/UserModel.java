package com.pulse.domain.system.user.model;
...
import com.pulse.domain.system.dept.model.DeptModelFactory;
import com.pulse.domain.system.post.model.PostModelFactory;
...
public class UserModel extends SysUserEntity {
    ...
    public boolean updateById() {
        if (this.getIsAdmin() && PulseConfig.isDemoEnabled()) {
